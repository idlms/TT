    ...
    // One command time
    0x40,//0x7D,                           // P23_A9_IR_SF1

    //----------------------------------------------

    // Time between 2 commands
    0x08,//0x13,//0x02,                           // P23_AE_IR_DPIR2, org 0x13
    0x60,//0x9f,//0xB0,                           // P23_AF_IR_DPIR3, org 0x9F
    ...
    // _BTI7 Length mode; _BIT6 Enable burst; _BIT4~_BIT0 data bits
     (_BIT7 | _BIT6 | 0x1F),         // P23_B3_IR_CR3//(_BIT7 | _BIT6 | 0x1F),         // P23_B3_IR_CR3
