...
// DEFINITIONS / MACROS
//****************************************************************************
#define _MAIN_PAGE_MODEL_NAME               _M__,_o__,_d__,_e__,_l__,__,_COLON__,__,_R__,_T__,_D__,_2__,_0__,_1__,_1__
...
void RTDFactoryOsdFuncShowNumber(BYTE ucRow, BYTE ucCol, DWORD ulValue, BYTE ucPar, BYTE ucFontPoint)
{
    ...
    pucDataSN[5] = (_0__ + (ulValue / 100000));
    pucDataSN[4] = (_0__ + (ulValue % 100000 / 10000));
    pucDataSN[3] = (_0__ + (ulValue % 10000) / 1000);
    pucDataSN[2] = (_0__ + (ulValue % 1000) / 100);
    pucDataSN[1] = (_0__ + (ulValue % 100) / 10);
    pucDataSN[0] = (_0__ + (ulValue % 10));

    for(ucIndex = 0; ucIndex < 6; ucIndex++)
    {
        if(pucDataSN[5 - ucIndex] != ((bit)(ucPar & _BIT1) ? 0x00 : _0__))
        {
            ucIndex = 5 - ucIndex;
            break;
        }
