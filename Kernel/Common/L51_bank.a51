...
?B_NBANKS       EQU  _DUAL_BANK_FLASH_PARTITION_TOTAL_BANKS;                  *
...
;User/both Code don't do this for use relocte function 30H
;Boot Code and No Dual bank case do this.
		DB      41H                        ; XData
                DW      ?B_XDATAPORT               ; Init XDATA Port
                DB      0 ; Set to intial bank
#endif
