...
#define GET_DP_RX1_HDCP2_CLEAR_DPCD_READ_VALUE_DONE()             (bit)(g_ucDPRx1Hdcp2Ctrl1 & _BIT2)
#define SET_DP_RX1_HDCP2_CLEAR_DPCD_READ_VALUE_DONE()             (g_ucDPRx1Hdcp2Ctrl1 |= _BIT2)
#define CLR_DP_RX1_HDCP2_CLEAR_DPCD_READ_VALUE_DONE()             (g_ucDPRx1Hdcp2Ctrl1 &= ~_BIT2)
...
extern void ScalerDpRx1Hdcp2ClearDpcdReadValue(BYTE ucRSAType, WORD usLength);
...
extern void ScalerDpRx1Hdcp2ChangeAuthState(EnumDpRxHdcp2RepeaterAuthState enumHdcp2AuthState);
extern void ScalerDpRx1Hdcp2SetRepeaterProcTimeout(void);
extern void ScalerDpRx1Hdcp2RepeaterCapableProc(void);
extern void ScalerDpRx1Hdcp2ClearDpcdRepeaterInfo(void);
