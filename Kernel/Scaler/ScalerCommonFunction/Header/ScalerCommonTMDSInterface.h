...
extern void ScalerTMDSSetAcOnHpdToggle(BYTE ucInputPort);
extern void ScalerTMDSSetDcOnHpdToggle(BYTE ucInputPort);	
extern void ScalerTMDSClearHpdFlag(BYTE ucInputPort);
extern void ScalerTMDSSetHpdTimeNormal(BYTE ucInputPort);
