...
#define GET_DP_TX_BYPASS_UNPLUG_CSN_IS_PENDING()                    (g_stTxMsgInfo.b1UnplugCSNIsPending)
#define SET_DP_TX_BYPASS_UNPLUG_CSN_IS_PENDING()                    (g_stTxMsgInfo.b1UnplugCSNIsPending = _TRUE)
#define CLR_DP_TX_BYPASS_UNPLUG_CSN_IS_PENDING()                    (g_stTxMsgInfo.b1UnplugCSNIsPending = _FALSE)
...
#define GET_DP_TX_INTERCEPT_DDCCI_MSG_STATUS()                      (g_bDPTxInterceptDdcciMsg)
#define SET_DP_TX_INTERCEPT_DDCCI_MSG_STATUS(x)                     (g_bDPTxInterceptDdcciMsg = (x))

#define GET_DP_TX_INTERCEPT_DDCCI_MSG_ADJUST_LCR()                  (g_bDPTxInterceptDdcciMsgAdjustLCR)
#define SET_DP_TX_INTERCEPT_DDCCI_MSG_ADJUST_LCR()                  (g_bDPTxInterceptDdcciMsgAdjustLCR = _TRUE)
#define CLR_DP_TX_INTERCEPT_DDCCI_MSG_ADJUST_LCR()                  (g_bDPTxInterceptDdcciMsgAdjustLCR = _FALSE)
#endif
