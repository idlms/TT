...
#define GET_DP_RX0_HDCP2_CLEAR_DPCD_READ_VALUE_DONE()             (bit)(g_ucDPRx0Hdcp2Ctrl1 & _BIT2)
#define SET_DP_RX0_HDCP2_CLEAR_DPCD_READ_VALUE_DONE()             (g_ucDPRx0Hdcp2Ctrl1 |= _BIT2)
#define CLR_DP_RX0_HDCP2_CLEAR_DPCD_READ_VALUE_DONE()             (g_ucDPRx0Hdcp2Ctrl1 &= ~_BIT2)
...
extern void ScalerDpRx0Hdcp2AkeInitProc_WDINT(void);
#endif

#if(_DP_TX_SUPPORT == _ON)
extern void ScalerDpRx0Hdcp2RepeaterHandler(void);
extern void ScalerDpRx0Hdcp2ChangeAuthState(EnumDpRxHdcp2RepeaterAuthState enumHdcp2AuthState);
extern void ScalerDpRx0Hdcp2SetRepeaterProcTimeout(void);
extern void ScalerDpRx0Hdcp2RepeaterCapableProc(void);
#endif
