...
#define _MAX_CBL_DISCOVER_ID_RETRY_FAIL_CNT     20
...
#define _SENDER_RESP_TIMER                      23      // 24 ~ 30ms
...
#define _SRC_SEND_PS_RDY_FIX_VOLTAGE_TIMER      35      // 35ms, Depends on PMIC control speed
#define _SRC_SEND_PS_RDY_PPS_MODE_TIMER         5       // 5ms
...
typedef enum
{
    _PD_CBL_ACTIVE_ELEMENT_UNDEFINED = 0x00,
    _PD_CBL_ACTIVE_REDRIVER = 0x01,
    _PD_CBL_ACTIVE_RETIMER = 0x02,
}EnumTypeCPDCableActiveElement;
...
typedef struct
{
    ...
    EnumTypeCPDCableActiveElement enumTypeCCableActiveElement;
...
typedef enum
{
    ...
    _PD_CBL_SEND_SOFT_RST = 0x03,
    _PD_CBL_INT_WAIT_SOFT_RST_RESP = 0x04,
...
typedef enum
{
    ...
    _PD_ALT_MODE_INT_WAIT_ATTENTION = 0x29,
    _PD_ALT_MODE_READY = 0x2A,
    _PD_ALT_MODE_ERROR = 0x2B,
}EnumPDAltModeState;
