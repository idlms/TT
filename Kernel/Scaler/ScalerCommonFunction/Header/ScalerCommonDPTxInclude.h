...
#define GET_DP_TX_HPD_DETECTION_ENABLE()                    1//(ScalerGetBit(PBB_70_HPD_CTRL, _BIT7) == _BIT7) // DPTX HPD  _PIN_71 Open ( remocon delay )
...
#define GET_DP_TX_DOWNSTREAM_LTTPR_NUM()                    (g_stDownStreamInfo.ucLTTPRNum)
#define SET_DP_TX_DOWNSTREAM_LTTPR_NUM(x)                   (g_stDownStreamInfo.ucLTTPRNum = (x))

#define GET_DP_TX_DOWNSTREAM_LTTPR_EXT_WAKE_TIMEOUT()       (g_stDownStreamInfo.ucExtWakeTimeout)
#define SET_DP_TX_DOWNSTREAM_LTTPR_EXT_WAKE_TIMEOUT(x)      (g_stDownStreamInfo.ucExtWakeTimeout = (x))
...
#define GET_DP_TX_AUDIO_STAND_ALONE_CHANGE_EVENT()          (g_stTxInputInfo.b1SleepAudioChangeEvent)
#define SET_DP_TX_AUDIO_STAND_ALONE_CHANGE_EVENT()          (g_stTxInputInfo.b1SleepAudioChangeEvent = _TRUE)
#define CLR_DP_TX_AUDIO_STAND_ALONE_CHANGE_EVENT()          (g_stTxInputInfo.b1SleepAudioChangeEvent = _FALSE)

#define GET_DP_TX_AUDIO_STAND_ALONE()                       (g_stTxInputInfo.b1SleepAudioSupport)
#define SET_DP_TX_AUDIO_STAND_ALONE()                       (g_stTxInputInfo.b1SleepAudioSupport = _TRUE)
#define CLR_DP_TX_AUDIO_STAND_ALONE()                       (g_stTxInputInfo.b1SleepAudioSupport = _FALSE)
#endif
...
#define GET_DP_TX_EDID_VENDOR_MODEL()                       (g_enumDpTxEdidVendorModel)
#define SET_DP_TX_EDID_VENDOR_MODEL(x)                      (g_enumDpTxEdidVendorModel = (x))
#define CLR_DP_TX_EDID_VENDOR_MODEL()                       (g_enumDpTxEdidVendorModel = 0)

#if(_DP_TX_HPD_HIGH_DEBOUNCE_SUPPORT == _ON)
//--------------------------------------------------
// Definitions of DP Tx HPD Debounce
//--------------------------------------------------
#define GET_DP_TX_HPD_DEBOUNCE()                            (g_stTxModeInfo.b1HPDDebounce)
#define SET_DP_TX_HPD_DEBOUNCE()                            (g_stTxModeInfo.b1HPDDebounce = _TRUE)
#define CLR_DP_TX_HPD_DEBOUNCE()                            (g_stTxModeInfo.b1HPDDebounce = _FALSE)
#endif
...
extern EnumDPTxEdidVendorModel g_enumDpTxEdidVendorModel;
