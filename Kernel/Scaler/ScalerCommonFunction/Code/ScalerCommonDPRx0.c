...
bit ScalerDpRx0InterlaceCheck(WORD *pusVTotal, BYTE *pucOddFlg)
{
    ...
    if(GET_AIO_MODERN_STANDBY_MODE() == _TRUE)
    {
        ...
        pData[1] = ((BYTE) g_stDpRx0LinkInfo.b1InterlaceFieldN) << 1;
        pData[2] = ((BYTE) g_stDpRx0LinkInfo.b1InterlaceFieldN1) << 1;
    }
    else
#endif
    {
        ...
        g_stDpRx0LinkInfo.b1InterlaceFieldN = (bit)(pData[1] & _BIT1);
        g_stDpRx0LinkInfo.b1InterlaceFieldN1 = (bit)(pData[2] & _BIT1);
#endif
    }
