...
#if((_D0_DP_TYPE_C_PORT_CTRL_SUPPORT == _ON) && (_D0_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_EMBEDDED))
            return GET_DP_RX0_ALT_MODE_HPD_STAUTS();
#else
...
void ScalerSyncInterfaceSwitch(BYTE ucInputPort, BYTE ucPortType, BYTE ucSourceSearchDelayMode)
{
    ...
    switch(ucInputPort)
    {
        ...
        case _D2_INPUT_PORT:
			...
			//--------------------------------------------------------------------------
			/*
			printf("GET_TMDS_RX2_AC_ON_HPD_TOGGLE_EVENT(%d)\n\r",(int)GET_TMDS_RX2_AC_ON_HPD_TOGGLE_EVENT());
			printf("GET_TMDS_RX2_DC_ON_HPD_TOGGLE_EVENT(%d)\n\r",(int)GET_TMDS_RX2_DC_ON_HPD_TOGGLE_EVENT());
			printf("GET_TMDS_RX2_PS_WAKEUP_HPD_TOGGLE(%d)\n\r",(int)GET_TMDS_RX2_PS_WAKEUP_HPD_TOGGLE());
			printf("GET_DIGITAL_PORT_SWITCH_TO_D2(%d)\n\r",(int)GET_DIGITAL_PORT_SWITCH_TO_D2());	
			*/
			//--------------------------------------------------------------------------
			if((ScalerSyncTMDSRx2HdmiColorInfoChanged() == _TRUE)
				&& (GET_DIGITAL_PORT_SWITCH_TO_D2() == _TRUE)
				&& (GET_TMDS_RX2_AC_ON_HPD_TOGGLE_EVENT() == _FALSE)
				&& (GET_TMDS_RX2_DC_ON_HPD_TOGGLE_EVENT() == _FALSE)
				&& (GET_TMDS_RX2_PS_WAKEUP_HPD_TOGGLE() == _FALSE))
			{
				printf("HDMI2-Rx2Hdmi Color Info Changed() >>>>>>> Action HPD (Change Color Format)\n\r");
			...
			if((GET_HDMI_HOTPLUG_TOGGLE() == _TRUE) && ((GET_DIGITAL_PORT_SWITCH_TO_D2() == _FALSE) || (GET_TMDS_RX2_PS_WAKEUP_HPD_TOGGLE() == _TRUE) || (GET_TMDS_RX2_AC_ON_HPD_TOGGLE_EVENT() == _TRUE)  || (GET_TMDS_RX2_DC_ON_HPD_TOGGLE_EVENT() == _TRUE)) && (GET_HDMI_Z0_HPD_TYPE() == _HDMI_HPD_Z0_TOGGLE_AT_SAME_TIME)) 
			{
#if(_HDMI_HPD_TOGGLE_BY_Z0_OFF_DDC_TOGGLE == _ON)
...
#endif
                    {
						if(GET_TMDS_RX2_AC_ON_HPD_TOGGLE_EVENT())			// AC On flag
							printf("HPD-HDMI2(AC On)\n\r");
						else if(GET_TMDS_RX2_DC_ON_HPD_TOGGLE_EVENT())		// DC On flag
							printf("HPD-HDMI2(DC On)\n\r");
						else if(GET_TMDS_RX2_PS_WAKEUP_HPD_TOGGLE())		// Wakeup flag
							printf("HPD-HDMI2(Wake Up)\n\r");
						else //(GET_DIGITAL_PORT_SWITCH_TO_D2() == _FALSE)	// Port Change OK
							printf("HPD-HDMI2(Source Change)\n\r");
						/*
						--------------------------------------------------------------
 										Mode1(0)  Mode2(1)  Mode3(2)  Mode 4(3)
						AC/DC PowerOn     O         O         O         X
						Source Change     O         O         X         X
						DPMS Wakeup       O         O         X         X
						No Signal         X         O         X         X
						
						ColorChange(Add)  O         O         O         O 
						--------------------------------------------------------------
						*/
						
						fgHPDActon = _FALSE;
						if((GetHpdMode()==0)&&((GET_TMDS_RX2_AC_ON_HPD_TOGGLE_EVENT() == _TRUE)  || (GET_TMDS_RX2_DC_ON_HPD_TOGGLE_EVENT() == _TRUE) || (GET_DIGITAL_PORT_SWITCH_TO_D2() == _FALSE) || (GET_TMDS_RX2_PS_WAKEUP_HPD_TOGGLE() == _TRUE)))
							fgHPDActon = _TRUE; // Mode1
						else if((GetHpdMode()==1)&&((GET_TMDS_RX2_AC_ON_HPD_TOGGLE_EVENT() == _TRUE)  || (GET_TMDS_RX2_DC_ON_HPD_TOGGLE_EVENT() == _TRUE) || (GET_DIGITAL_PORT_SWITCH_TO_D2() == _FALSE) || (GET_TMDS_RX2_PS_WAKEUP_HPD_TOGGLE() == _TRUE)))
							fgHPDActon = _TRUE;  // Mode2
						else if((GetHpdMode()==2)&&((GET_TMDS_RX2_AC_ON_HPD_TOGGLE_EVENT() == _TRUE)  || (GET_TMDS_RX2_DC_ON_HPD_TOGGLE_EVENT() == _TRUE)))
							fgHPDActon = _TRUE; // Mode3
						else if(GetHpdMode()==3)
							fgHPDActon = _FALSE;// Mode4
						
						if(fgHPDActon)
						{
							printf("ScalerSyncInterfaceSwitch(_D2_INPUT_PORT) Step1\n\r");	//  Action HPD
	                        SET_TMDS_RX2_HPD_TRIGGER_EVENT(_TMDS_HPD_NORMAL);
	                        ScalerTMDSHotPlugEvent(_D2_INPUT_PORT);
	                    }
						else
						{
							printf("ScalerSyncInterfaceSwitch(_D2_INPUT_PORT) Step1 - No HPD \n\r");
						}
						CLR_TMDS_RX2_PS_WAKEUP_HPD_TOGGLE();
						CLR_TMDS_RX2_AC_ON_HPD_TOGGLE_EVENT();	// Clear Event
        ...
        case _D3_INPUT_PORT:
			...
			//--------------------------------------------------------------------------
			/*
			printf("GET_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT(%d)\n\r",(int)GET_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT());	
			printf("GET_TMDS_RX3_DC_ON_HPD_TOGGLE_EVENT(%d)\n\r",(int)GET_TMDS_RX3_DC_ON_HPD_TOGGLE_EVENT());
			printf("GET_TMDS_RX3_PS_WAKEUP_HPD_TOGGLE(%d)\n\r",(int)GET_TMDS_RX3_PS_WAKEUP_HPD_TOGGLE());
			printf("GET_DIGITAL_PORT_SWITCH_TO_D3(%d)\n\r",(int)GET_DIGITAL_PORT_SWITCH_TO_D3());	
			*/
			//--------------------------------------------------------------------------
			if((ScalerSyncTMDSRx3HdmiColorInfoChanged() == _TRUE)
				&& (GET_DIGITAL_PORT_SWITCH_TO_D3() == _TRUE)
				&& (GET_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT() == _FALSE)
				&& (GET_TMDS_RX3_DC_ON_HPD_TOGGLE_EVENT() == _FALSE)
				&& (GET_TMDS_RX3_PS_WAKEUP_HPD_TOGGLE() == _FALSE))	
			{
				printf("HDMI1-Rx3Hdmi Color Info Changed() >>>>>>> Action HPD (Change Color Format)\n\r");
			...
			if((GET_HDMI_HOTPLUG_TOGGLE() == _TRUE) && ((GET_DIGITAL_PORT_SWITCH_TO_D3() == _FALSE) || (GET_TMDS_RX3_PS_WAKEUP_HPD_TOGGLE() == _TRUE) || (GET_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT() == _TRUE) || (GET_TMDS_RX3_DC_ON_HPD_TOGGLE_EVENT() == _TRUE)) && (GET_HDMI_Z0_HPD_TYPE() == _HDMI_HPD_Z0_TOGGLE_AT_SAME_TIME))	
           	{
#if(_HDMI_HPD_TOGGLE_BY_Z0_OFF_DDC_TOGGLE == _ON)
...
#endif
                    {
						if(GET_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT())		 // AC On flag
							printf("HPD-HDMI1(AC On)\n\r");
						else if(GET_TMDS_RX3_DC_ON_HPD_TOGGLE_EVENT())	 // DC On flag	
							printf("HPD-HDMI1(DC On)\n\r");
						else if(GET_TMDS_RX3_PS_WAKEUP_HPD_TOGGLE())	 // Wakeup flag
							printf("HPD-HDMI1(Wake Up)\n\r");
						else//(GET_DIGITAL_PORT_SWITCH_TO_D3() == _FALSE) // Port Change OK
							printf("HPD-HDMI1(Source Change)\n\r");
						...
						*/
						fgHPDActon = _FALSE;
						if((GetHpdMode()==0)&&((GET_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT() == _TRUE)  || (GET_TMDS_RX3_DC_ON_HPD_TOGGLE_EVENT() == _TRUE) || (GET_DIGITAL_PORT_SWITCH_TO_D3() == _FALSE) || (GET_TMDS_RX3_PS_WAKEUP_HPD_TOGGLE() == _TRUE) ))
							fgHPDActon = _TRUE;	// Mode1
						else if((GetHpdMode()==1)&&((GET_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT() == _TRUE)  || (GET_TMDS_RX3_DC_ON_HPD_TOGGLE_EVENT() == _TRUE) || (GET_DIGITAL_PORT_SWITCH_TO_D3() == _FALSE)  || (GET_TMDS_RX3_PS_WAKEUP_HPD_TOGGLE() == _TRUE)))
							fgHPDActon = _TRUE; // Mode2
						else if((GetHpdMode()==2)&&((GET_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT() == _TRUE)  || (GET_TMDS_RX3_DC_ON_HPD_TOGGLE_EVENT() == _TRUE)))
							fgHPDActon = _TRUE;	// Mode3
						else if(GetHpdMode()==3)
							fgHPDActon = _FALSE;// Mode4
						...
						if(fgHPDActon)
						{
							printf("ScalerSyncInterfaceSwitch(_D3_INPUT_PORT) Step1\n\r");	// Action HPD
                        	SET_TMDS_RX3_HPD_TRIGGER_EVENT(_TMDS_HPD_NORMAL);
                        	ScalerTMDSHotPlugEvent(_D3_INPUT_PORT);
						}
						else
						{
							printf("ScalerSyncInterfaceSwitch(_D3_INPUT_PORT) Step1 - No HPD \n\r");
						}
                        CLR_TMDS_RX3_PS_WAKEUP_HPD_TOGGLE();
						CLR_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT();	// Clear Event
