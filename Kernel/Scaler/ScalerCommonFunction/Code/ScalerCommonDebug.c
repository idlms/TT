...
bit ScalerDebugCheckDebugPort(BYTE ucInputPort)
{
    switch(ucInputPort)
    {
#if((_D0_TMDS_SUPPORT == _ON) && (_DEBUG_DDC_CHANNEL_SEL == _DDC0))
        case _D0_INPUT_PORT:

            return _TRUE;
#endif

#if((_D1_TMDS_SUPPORT == _ON) && (_DEBUG_DDC_CHANNEL_SEL == _DDC1))
        case _D1_INPUT_PORT:

            return _TRUE;
#endif

#if((_D2_TMDS_SUPPORT == _ON) && (_DEBUG_DDC_CHANNEL_SEL == _DDC2))
        case _D2_INPUT_PORT:
