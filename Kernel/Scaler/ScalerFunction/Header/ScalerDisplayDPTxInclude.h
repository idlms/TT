...
#define GET_DISPLAY_DP_TX_LANE_NUM()                                (g_stDisplayDPTx1Info.b3LaneNum)
...
#define GET_DISPLAY_DP_TX1_IRQ_HPD_DETECTED()                       (g_bDisplayDpTx1IrqHpdDetected)
#define SET_DISPLAY_DP_TX1_IRQ_HPD_DETECTED()                       (g_bDisplayDpTx1IrqHpdDetected = _TRUE)
#define CLR_DISPLAY_DP_TX1_IRQ_HPD_DETECTED()                       (g_bDisplayDpTx1IrqHpdDetected = _FALSE)
#endif
...
#if(_PANEL_DPTX_IRQ_HPD_DETECT == _ON)
#define GET_DISPLAY_DP_TX2_IRQ_HPD_DETECTED()                       (g_bDisplayDpTx2IrqHpdDetected)
#define SET_DISPLAY_DP_TX2_IRQ_HPD_DETECTED()                       (g_bDisplayDpTx2IrqHpdDetected = _TRUE)
#define CLR_DISPLAY_DP_TX2_IRQ_HPD_DETECTED()                       (g_bDisplayDpTx2IrqHpdDetected = _FALSE)
#endif
...
#if(_PANEL_DPTX_8_LANE_LT_SYNCHRONIZE == _ON)
extern StructDPTxLTInfo g_stDisplayDPTxLTInfo;
#endif
...
#if(_PANEL_DPTX_IRQ_HPD_DETECT == _ON)
extern volatile bit g_bDisplayDpTx1IrqHpdDetected;
#endif
#endif
...
#if(_PANEL_DPTX_IRQ_HPD_DETECT == _ON)
extern volatile bit g_bDisplayDpTx2IrqHpdDetected;
#endif
#endif
...
#if(_PANEL_DPTX_HPD_DETECT == _ON)
#if(_PANEL_DPTX_IRQ_HPD_DETECT == _ON)
extern void ScalerDisplayDPTx1IrqIntHandler_EXINT0(void);
#endif
#endif
...
#if(_PANEL_DPTX_HPD_DETECT == _ON)
#if(_PANEL_DPTX_IRQ_HPD_DETECT == _ON)
extern void ScalerDisplayDPTx2IrqIntHandler_EXINT0(void);
#endif
#endif
