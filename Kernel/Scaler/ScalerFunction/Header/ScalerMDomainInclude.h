...
//--------------------------------------------------
// Macros of Bypass Timing
//--------------------------------------------------
#if(_TMDS_CLK_INTERRUPTION_CHECK == _ON)
#define GET_MDOMAIN_V_SCALING_BYPASS_TIMING()           (g_bByPassTiming)
#define SET_MDOMAIN_V_SCALING_BYPASS_TIMING()           (g_bByPassTiming = _TRUE)
#define CLR_MDOMAIN_V_SCALING_BYPASS_TIMING()           (g_bByPassTiming = _FALSE)
#endif
