...
void ScalerPLLSetDPLLFreqMN(DWORD ulFreq)
{
    ...
    else if ((_PANEL_STYLE == _PANEL_VBO) || (_PANEL_STYLE == _PANEL_DPTX)) // Elif of #if(_PANEL_STYLE == _PANEL_LVDS)
    {
        ScalerPLLSetDisplayPLL(ulFreq);
    }
...
void ScalerPLLSetDPLLFreqNfCascade(DWORD ulFreq)
{
    ...
    if ((_PANEL_STYLE == _PANEL_VBO) || (_PANEL_STYLE == _PANEL_DPTX)) // Elif of #if(_PANEL_STYLE == _PANEL_LVDS)
    ...
    if ((_PANEL_STYLE == _PANEL_DPTX) || (_PANEL_STYLE == _PANEL_LVDS))
    {
...
void ScalerPLLSetDPLLFreqNf(DWORD ulFreq)
{
    ...
    else if (_PANEL_STYLE == _PANEL_DPTX) // Elif of #if(_PANEL_STYLE == _PANEL_LVDS)
        ScalerPLLSetDPLLRefPLL(ulFreq);
...
#if ((_DPLL_STRUCT_TYPE == _DPLL_STRUCT_N_F_COMBO_LVDSPLL) || (_DPLL_STRUCT_TYPE == _DPLL_STRUCT_N_F))
    else if ((_DPLL_STRUCT_TYPE == _DPLL_STRUCT_N_F_COMBO_LVDSPLL) || (_DPLL_STRUCT_TYPE == _DPLL_STRUCT_N_F))
