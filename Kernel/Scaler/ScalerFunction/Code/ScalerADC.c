...
void ScalerADCGainAdjust(BYTE *pucGainMSB, BYTE *pucGainLSB)
{
    ...
    ScalerSetByte(P0_C0_ADC_GAI_RED_MSB, 255-pucGainMSB[0]);	// Reverse ( Gain Value )
    ScalerSetByte(P0_C1_ADC_GAI_GRN_MSB, 255-pucGainMSB[1]);
    ScalerSetByte(P0_C2_ADC_GAI_BLU_MSB, 255-pucGainMSB[2]);
...
{
    // Set ADC Gain High Byte Factor
    ScalerSetByte(P0_C3_ADC_OFF_RED_MSB, 255-pucOffsetMSB[0]);	// Reverse ( Offset Value )
    ScalerSetByte(P0_C4_ADC_OFF_GRN_MSB, 255-pucOffsetMSB[1]);
    ScalerSetByte(P0_C5_ADC_OFF_BLU_MSB, 255-pucOffsetMSB[2]);
