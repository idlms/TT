...
bit ScalerMeasureCheckInputInfoConsistency(EnumSourceTypeDef enumSourceType, EnumSourceSearchPort enumSourceSearchPort)
{
    ...
    if(((enumSourceType == _SOURCE_DVI) || (enumSourceType == _SOURCE_HDMI)) && (GET_INPUT_TIMING_HSTART() <= 72) &&
       (ScalerTMDSGetDeOnlyModeConfig(enumSourceSearchPort) == (EnumDeOnlyConfig)(_DE_ONLY_ENABLE | _DE_ONLY_HS_72T)))
    {
