...
void ScalerTMDSRx4SetDeOnlyModeConfig(EnumDeOnlyConfig enumDeonlyConfig);
EnumDeOnlyConfig ScalerTMDSRx4GetDeOnlyModeConfig(void);
...
void ScalerTMDSRx4ScrambleStatusReset(void);
void ScalerTMDSRx4ScrambleDetectTimeoutTimerEvent(void);
void ScalerTMDSRx4ScrambleDetectDisable(void);
#endif
#endif
...
bit ScalerTMDSRx4TMDSNormalPreDetect(void)
{
    ...
    if(ScalerDebugCheckDebugPort(_D4_INPUT_PORT) == _FALSE)
#endif
    {
