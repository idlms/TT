...
void ScalerAutoGetAutoColorResult(StructAdcDataType *pstAdcData)
{
	...
	pstAdcData->pucAdcGainMSB[0] = 255-pstAdcData->pucAdcGainMSB[0];		// Reverse ( Gain Value )
	pstAdcData->pucAdcGainMSB[1] = 255-pstAdcData->pucAdcGainMSB[1];
	pstAdcData->pucAdcGainMSB[2] = 255-pstAdcData->pucAdcGainMSB[2];

	pstAdcData->pucAdcOffsetMSB[0] = 255-pstAdcData->pucAdcOffsetMSB[0];	// Reverse ( Offset Value )
	pstAdcData->pucAdcOffsetMSB[1] = 255-pstAdcData->pucAdcOffsetMSB[1];
	pstAdcData->pucAdcOffsetMSB[2] = 255-pstAdcData->pucAdcOffsetMSB[2];
}
