...
void ScalerGlobalSystemClkReset(void);
...
//--------------------------------------------------
// Description  : Scaler MCU_FFEE_MCU_CLOCK_CONTROL
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerGlobalSystemClkReset(void)
{
    MCU_FFEE_MCU_CLOCK_CONTROL = _BIT1|_BIT0;
}
...
#endif  
            memset(&(g_stInputTimingData), 0x00, sizeof(StructTimingInfo));
            //reset Timing Info 
