...
void ScalerTMDSRx2Hdcp2RxRsaCalculate_EXINT0(void);
...
void ScalerTMDSRx2Hdcp2RxRsaCalculate_WDINT(void);
void ScalerTMDSRx2Hdcp2SetRdMsgIDCode_WDINT(BYTE ucValue);
void ScalerTMDSRx2Hdcp2SetRdMsgValue_WDINT(WORD usAddress, BYTE *pucReadArray, WORD usLength);
void ScalerTMDSRx2Hdcp2HPrime_WDINT(void);
#endif
...
//--------------------------------------------------
void ScalerTMDSRx2Hdcp2RxRsaCalculate_EXINT0(void) using 1
{
    ...
    // delay to check RSA
    ScalerTimerWDActivateTimerEvent_EXINT0(10, _SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_CHECK_RSA_CAL_DONE);
}
            ...
            case _HDCP_2_2_AKE_NO_STORED_KM:
                ...
                if(ScalerHdcp2RsaAvailable_EXINT0() == _TRUE)
                {
                    if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT7) == _BIT7) // RSA power on
                    {
                        ...
                        ScalerTimerWDActivateTimerEvent_EXINT0(10, _SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_RSA_CAL_START);
                    }
                    else
                    {
                        ScalerTMDSRx2Hdcp2RxRsaCalculate_EXINT0();
                    }
                }
...
void ScalerTMDSRx2Hdcp2ResetProc(void)
{
    ...
    ScalerTimerWDCancelTimerEvent(_SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_RSA_CAL_START);
...
void ScalerTMDSRx2Hdcp2ResetProc_EXINT0(void) using 1
{
    ...
    // Cancel HDCP 2.2 RSA Cal Timer Event
    ScalerTimerWDCancelTimerEvent_EXINT0(_SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_RSA_CAL_START);
...
// Output Value : _TRUE or _FALSE
//--------------------------------------------------
void ScalerTMDSRx2Hdcp2RxRsaCalculate_WDINT(void) using 3
{
    BYTE pucHdcp2KpubKm[128];
    BYTE ucIndex = 0;
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx2Hdcp2SetRdMsgIDCode_WDINT(BYTE ucValue) using 3
{
    ScalerSetBit_EXINT(P2D_23_HDCP_MSGRAP_H, ~(_BIT1 | _BIT0), 0x00);
    ScalerSetByte_EXINT(P2D_24_HDCP_MSGRAP_L, 0x00);
    ScalerSetByte_EXINT(P2D_25_HDCP_MSGRDP, ucValue);
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx2Hdcp2SetRdMsgValue_WDINT(WORD usAddress, BYTE *pucReadArray, WORD usLength) using 3
{
    WORD usTemp = 0;
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx2Hdcp2HPrime_WDINT(void) using 3
{
    ScalerHdcp2DkeyCalculate_WDINT(_HDCP_2_2_DKEY_0, g_pucTmdsRx2Hdcp2Rtx, g_pucTmdsRx2Hdcp2Rrx, g_pucTmdsRx2Hdcp2Km, g_pucTmdsRx2Hdcp2Rn);

    memcpy(g_pucTmdsRx2Hdcp2dKey0, (volatile BYTE xdata *)P63_81_HDCP_AES_OUT_15, 16);

    ScalerHdcp2DkeyCalculate_WDINT(_HDCP_2_2_DKEY_1, g_pucTmdsRx2Hdcp2Rtx, g_pucTmdsRx2Hdcp2Rrx, g_pucTmdsRx2Hdcp2Km, g_pucTmdsRx2Hdcp2Rn);

    memcpy(g_pucTmdsRx2Hdcp2dKey1, (volatile BYTE xdata *)P63_81_HDCP_AES_OUT_15, 16);

    if(ScalerHdcp2HPrimeCalculate_WDINT(g_pucTmdsRx2Hdcp2dKey0, g_pucTmdsRx2Hdcp2dKey1, g_pucTmdsRx2Hdcp2Rtx, g_pucTmdsRx2Hdcp2TxCaps, g_pucTmdsRx2Caps) == _TRUE)
    {
        memset(g_pucHdcp2Sha256, 0, sizeof(g_pucHdcp2Sha256));

        // Load H prime to Read SRAM, AKE Send H PRIME Message ID = 0x07
        ScalerTMDSRx2Hdcp2SetRdMsgIDCode_WDINT(_HDCP_2_2_AKE_SEND_H_PRIME);

        memcpy(g_pucHdcp2Sha256, (volatile BYTE xdata *)P63_35_HDCP_SHA_0, 32);

        // Load Km to Read SRAM
        ScalerTMDSRx2Hdcp2SetRdMsgValue_WDINT(0x01, g_pucHdcp2Sha256, 32);
