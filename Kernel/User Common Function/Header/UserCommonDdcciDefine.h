...
#define _DDCCI_OPCODE_VCP_DICOM_PRESET_ADDRESS    	0xC1
#define _DDCCI_OPCODE_VCP_DICOM_PRESET_VALUE	    0xC2
#define _DDCCI_OPCODE_VCP_DICOM_GAMMA_TABLE_OP	    0xC3
#define _DDCCI_OPCODE_VCP_DICOM_INFO				0xC4
#else
