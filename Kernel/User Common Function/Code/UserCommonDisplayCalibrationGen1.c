...
#define _DISP_CALIB_GET_FW_ADVANCE  10
...
#endif
#define _DCIP3_SRGB_PRECISION       (_DCIP3_NO_COMPRESSION_SUPPORT ? _SRGB_1_BIT_SHIFT_LEFT : _SRGB_0_BIT_SHIFT_LEFT)
#define _USER_DEFINE_PRECISION      (_OCC_USER_DEFINE_SHIFT_1_BIT_SUPPORT ? _SRGB_1_BIT_SHIFT_LEFT : _SRGB_0_BIT_SHIFT_LEFT)
#define _OGC_GAMMA_MAX              (_OGC_TOTAL_GAMMA * _OGC_SUPPORT)
...
//--------------------------------------------------
#define _DISP_CALIB_FW_VERSION      0x0013
#define _DISP_CALIB_UNI_VERSION     0x0009
...
#if((_HDR10_SUPPORT == _ON) || ((_TWO_BRI_CALIBRATION_TYPE == _TWO_BRI_CALIBRATION_OGC_OCC_DICOM_HDR) && (_OCC_SUPPORT == _ON)))
...
BYTE g_ucDCIP3MatrixType;
#endif
#if(_OCC_USER_DEFINE_SHIFT_1_BIT_SUPPORT == _ON)
BYTE g_ucUserDefineMatrixType;
#endif
...
void UserCommonDdcciDispCalibReplyOGCNEWLvRatio(void);
...
//****************************************************************************************//
        ...
        {
            if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_FW_INFO] == _DDCCI_DISP_CALIB_GET_FW_DEFINE)
            {
                UserCommonDdcciDispCalibReplyResult(_DISP_CALIB_START);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_FW_INFO] == _DDCCI_DISP_CALIB_GET_FW_VERSION)
            {
            ...
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_FW_INFO] == _DDCCI_DISP_CALIB_GET_FW_ADVANCE_DEFINE)
            {
                UserCommonDdcciDispCalibReplyResult(_DISP_CALIB_GET_FW_ADVANCE);
            }
            ScalerMcuDdcciReleaseScl();
            return;
        }
        ...
        else if(ucCalibrationStep == _DDCCI_DISP_CALIB_OGC_MEASURE_RED)
        {
            ...
            {
                ucGammaBankNum = UserCommonAdjustOGCBank(_OGC_GAMMA_MAX, _OGC_MAX_BACKLIGHT_TYPE);
                pucGammaBankAddr = UserCommonAdjustOGCAddr(_OGC_GAMMA_MAX, _OGC_MAX_BACKLIGHT_TYPE);
...
//****************************************************************************************//
        ...
        else if(ucCalibrationStep == _DDCCI_DISP_CALIB_SET_PCM)
        {
            ...
            if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_DISPLAY_P3)
            {
                // force Set PCM Input Gamma 2.2
            ...
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            ...
            {
                ScalerColorPCMSRGBAdjust(_DCIP3_SRGB_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_DCIP3_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            ...
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE2_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_3)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE3_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_4)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE4_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_5)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE5_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_6)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE6_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_DISPLAY_P3)
            {
                ScalerColorPCMSRGBAdjust(_DCIP3_SRGB_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_DISPLAYP3_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else // if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_STANDARD)
            {
                ScalerColorPCMSRGBAdjust(_SRGB_0_BIT_SHIFT_LEFT, g_pucDISP_CALIBRATION_FLASH + _OCC_SRGBMATRIX_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
#else
            ScalerColorPCMOutputGammaAdjust(g_pucDISP_CALIBRATION_FLASH + _OCC_GAMMA10_ADDRESS + (g_ucBacklightFlag * _OCC_GAMMA_TABLE_SIZE), _OGC_FLASH_BANK);

            // Set PCM Color Matrix
            if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_SRGB)
            {
                ScalerColorPCMSRGBAdjust(_SRGB_0_BIT_SHIFT_LEFT, g_pucDISP_CALIBRATION_FLASH + _OCC_SRGBMATRIX_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_ADOBE_RGB)
            {
                ScalerColorPCMSRGBAdjust(_SRGB_0_BIT_SHIFT_LEFT, g_pucDISP_CALIBRATION_FLASH + _OCC_ADOBEMATRIX_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_EBU_MODE)
            {
                ScalerColorPCMSRGBAdjust(_SRGB_0_BIT_SHIFT_LEFT, g_pucDISP_CALIBRATION_FLASH + _OCC_EBU_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_SOFT_PROFT)
            {
                ScalerColorPCMSRGBAdjust(_SRGB_0_BIT_SHIFT_LEFT, g_pucDISP_CALIBRATION_FLASH + _OCC_SOFTPROOF_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_REC_709)
            {
                ScalerColorPCMSRGBAdjust(_SRGB_0_BIT_SHIFT_LEFT, g_pucDISP_CALIBRATION_FLASH + _OCC_REC709_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_DCI_P3)
            {
                ScalerColorPCMSRGBAdjust(_DCIP3_SRGB_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_DCIP3_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_SMPTE_C)
            {
                ScalerColorPCMSRGBAdjust(_SRGB_0_BIT_SHIFT_LEFT, g_pucDISP_CALIBRATION_FLASH + _OCC_SMPTEC_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_2)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE2_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_3)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE3_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_4)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE4_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_5)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE5_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_6)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE6_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else  if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_DISPLAY_P3)
            {
                ScalerColorPCMSRGBAdjust(_DCIP3_SRGB_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_DISPLAYP3_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else // if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_STANDARD)
            {
                ScalerColorPCMSRGBAdjust(_SRGB_0_BIT_SHIFT_LEFT, g_pucDISP_CALIBRATION_FLASH + _OCC_SRGBMATRIX_ADDRESS + (g_ucBacklightFlag * _OCC_COLOR_MATRIX_TOTAL_SPACE), _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
        ...
        {
#if(_OGC_TOTAL_DICOM > 1)
            ucDICOMIndex = g_pucDISP_CALIBRATION_FLASH[_DDCCI_DISP_CALIB_INDEX];
#else
        ...
        {
            UserCommonDdcciDispCalibReplyOGCNEWLvRatio();
            ScalerMcuDdcciReleaseScl();
        ...
        {
            switch((g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_UNIFORMITY_INDEX] & 0x07) | ((g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_UNIFORMITY_INDEX] & 0xE0) >> 2))
            {
                case 0:
                ...
                case 6:
                    UserCommonDdcciDispCalibReplyOCCMatrix(_PCM_REC_709);
                    break;

                case 7:
                    UserCommonDdcciDispCalibReplyOCCMatrix(_PCM_SMPTE_C);
                    break;

                case 8:
                    UserCommonDdcciDispCalibReplyOCCMatrix(_PCM_EBU_MODE);
                    break;

                case 9:
                    UserCommonDdcciDispCalibReplyOCCMatrix(_PCM_USER_DEFINE_3);
                    break;

                case 10:
                    UserCommonDdcciDispCalibReplyOCCMatrix(_PCM_USER_DEFINE_4);
                    break;

                case 11:
                    UserCommonDdcciDispCalibReplyOCCMatrix(_PCM_USER_DEFINE_5);
                    break;

                case 12:
                    UserCommonDdcciDispCalibReplyOCCMatrix(_PCM_USER_DEFINE_6);
                    break;
...
#if(_TWO_BRI_CALIBRATION_TYPE == _TWO_BRI_CALIBRATION_OGC_OCC_DICOM_HDR)
            g_ucBacklightFlag = _MAX_BACKLIGHT_CAL;
#endif
            ScalerMcuDdcciReleaseScl();
            return;
        }
        ...
        else if(ucCalibrationStep == _DDCCI_DISP_CALIB_UNIFORMITY_SET_PCM)
        {
            ...
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE_MAX_BRI_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_EBU_MODE)
            {
            ...
            {
                ScalerColorPCMSRGBAdjust(_DCIP3_SRGB_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_DCIP3_MAX_BRI_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_SMPTE_C)
            {
            ...
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE2_MAX_BRI_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_3)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE3_MAX_BRI_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_4)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE4_MAX_BRI_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_5)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE5_MAX_BRI_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_USER_DEFINE_6)
            {
                ScalerColorPCMSRGBAdjust(_USER_DEFINE_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_USERDEFINE6_MAX_BRI_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
            else // if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_PCM_COLOR_DOMAIN] == _PCM_DISPLAY_P3)
            {
                ScalerColorPCMSRGBAdjust(_DCIP3_SRGB_PRECISION, g_pucDISP_CALIBRATION_FLASH + _OCC_DISPLAYP3_MAX_BRI_ADDRESS, _OGC_FLASH_BANK, _OCC_COLORMATRIX_TABLE_SIZE);
            }
#endif
            ScalerColorOutputGammaEnable(_FUNCTION_ON);
            ScalerColorSRGBEnable(_FUNCTION_ON);
...
#endif
            {
                ScalerColorPCMInputGammaLoadTable(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_INDEX]);
            }
...
#if(_DCIP3_NO_COMPRESSION_SUPPORT == _ON)
    g_ucDCIP3MatrixType = (g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_TYPE_II] & _BIT2) >> 2;
    if(!g_ucDCIP3MatrixType)
    {
        ucFlag = 0;
    }
#endif
#if(_OCC_USER_DEFINE_SHIFT_1_BIT_SUPPORT == _ON)
    g_ucUserDefineMatrixType = (g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_TYPE_II] & _BIT3) >> 3;
    if(!g_ucUserDefineMatrixType)
    {
        ucFlag = 0;
    }
#endif
...
#if(_OGC_TOTAL_DICOM > 1)
        else if(ucGammaIndex == _DICOM2_POSITION)
        {
            usStartAddr = tGAMMA_INDEX[_DICOM2_POSITION] + (ucRGB) * 2052;
        }
#endif
#endif
        else
    ...
    switch(ucCheckType)
    {
        ...
        case _DICOM_TYPE:
            ...
            for(usJ = 0; usJ < 3; usJ++)
            {
                for(usI = 0; usI < 2052; usI = usI + 8)
                {
                    UserCommonFlashRead(_OGC_FLASH_BANK, ((((WORD)_OGC_FLASH_PAGE) << 12) + _OGC_DICOM2_ADDRESS + usJ * 2052 + usI), 2, pData + 2);
                    pData[0] += pData[2];
                    pData[0] += pData[3];
                }
            }
        ...
        case _HDR_USER_DEFINE_FIXED_POINT_TYPE:
            for(usJ = 0; usJ < 8; usJ++)
            {
                for(usI = 0; usI < _OGC_HDR10_IG_TABLE_SIZE; usI++)
                {
                    UserCommonFlashRead(_OGC_FLASH_BANK, ((((WORD)_OGC_FLASH_PAGE) << 12) + _OGC_HDR10_IG_540_USER_FIXED_NOR_ADDRESS + _OGC_HDR10_IG_TABLE_SIZE * usJ + usI), 1, pData + 2);
                    pData[0] += pData[2];
                }
            }
            break;
...
BYTE UserCommonDdcciDispCalibMatrixCheckSum(BYTE ucCheckType)
{
    ...
    switch(ucCheckType)
    {
        ...
        case _FREESYNC_II_PQ_TYPE:
            ...
            pucTemp[0] = UserCommonDdcciDispCalibCalCheckSum(_FREESYNC_II_PQ_TYPE);
...
#if(_HDR10_USER_DEFINE_FIXED_POINT_TONEMAPPING_SUPPORT == _ON)
        case _HDR_USER_DEFINE_FIXED_POINT_TYPE:
            pucTemp[0] = UserCommonDdcciDispCalibCalCheckSum(_HDR_USER_DEFINE_FIXED_POINT_TYPE);
...
void UserCommonDdcciDispCalibReplyResult(BYTE ucType)
{
    ...
    switch(ucType)
    {
        ...
        case _DISP_CALIB_GET_NOTM_INFO:
            ...
            g_pucDdcciTxBuf[_DDCCI_DISP_CALIB_MIN_LV] = _PANEL_MIN_LUMINANCE;
        ...
        case _DISP_CALIB_GET_FW_SUPPORT:
            ...
            g_pucDdcciTxBuf[_DDCCI_SOURCE] = _DDCCI_DEST_ADDRESS;
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | 0x02;
            g_pucDdcciTxBuf[_DDCCI_DISP_CALIB_FW_SUPPORT] = ((_OCC_USER_DEFINE_SHIFT_1_BIT_SUPPORT << 7) | ((_OGC_TOTAL_DICOM - 1) & 0x03) << 5) | (_DCIP3_NO_COMPRESSION_SUPPORT << 4) | ((_DISPLAY_HDR_VERSION == _DISPLAY_HDR_VERSION_1_1) << 2) | (_HDR10_USER_DEFINE_PANEL_MAX_LV_SUPPORT << 1) | _LD_HDR10_BOOST_SUPPORT;
        ...
        case _DISP_CALIB_GET_FW_ADVANCE:
            g_pucDdcciTxBuf[_DDCCI_SOURCE] = _DDCCI_DEST_ADDRESS;
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | 0x05;
            g_pucDdcciTxBuf[_DDCCI_DISP_CALIB_ADVANCE_1] = (_OCC_DISPLAY_P3_GAMMA_22_SUPPORT << 4) | (_HDR10_USER_DEFINE_FIXED_POINT_TONEMAPPING_SUPPORT << 3);
            g_pucDdcciTxBuf[_DDCCI_DISP_CALIB_ADVANCE_2] = 0x00;
            g_pucDdcciTxBuf[_DDCCI_DISP_CALIB_ADVANCE_3] = 0x00;
            g_pucDdcciTxBuf[_DDCCI_DISP_CALIB_ADVANCE_4] = 0x00;
            g_pucDdcciTxBuf[_DDCCI_DISP_CALIB_ADVANCE_5] = 0x00;
            g_pucDdcciTxBuf[_DDCCI_DISP_CALIB_ADVANCE_5 + 1] = UserCommonDdcciCalCheckSum();
...
void UserCommonDdcciDispCalibReplyOCCMatrix(BYTE ucPCMType)
{
    ...
    usReadStartPos = (WORD)ucSendLength * ((g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_UNIFORMITY_INDEX] >> 3) & 0x03);
    ...
    switch(ucPCMType)
    {
        ...
        case _PCM_REC_709:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_REC709_MAX_BRI_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_SMPTE_C:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_SMPTEC_MAX_BRI_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_EBU_MODE:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_EBU_MAX_BRI_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_USER_DEFINE_3:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_USERDEFINE3_MAX_BRI_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_USER_DEFINE_4:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_USERDEFINE4_MAX_BRI_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_USER_DEFINE_5:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_USERDEFINE5_MAX_BRI_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_USER_DEFINE_6:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_USERDEFINE6_MAX_BRI_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
    ...
    switch(ucPCMType)
    {
        ...
        case _PCM_REC_709:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_REC709_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_SMPTE_C:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_SMPTEC_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_EBU_MODE:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_EBU_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_USER_DEFINE_3:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_USERDEFINE3_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_USER_DEFINE_4:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_USERDEFINE4_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_USER_DEFINE_5:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_USERDEFINE5_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
        ...
        case _PCM_USER_DEFINE_6:
            ...
            g_pucDdcciTxBuf[_DDCCI_LENGTH] = _DDCCI_CONTROL_STATUS_FLAG | ucSendLength;
            UserCommonFlashRead(_OGC_FLASH_BANK, ((WORD)_OGC_FLASH_PAGE << 12) + _OCC_USERDEFINE6_ADDRESS + (WORD)usReadStartPos, ucSendLength, g_pucDdcciTxBuf + _DDCCI_COMMAND);
            g_pucDdcciTxBuf[_DDCCI_COMMAND + ucSendLength] = UserCommonDdcciCalCheckSum();
...
void UserCommonDdcciDispCalibReplyOGCNEWLvRatio(void)
{
    ...
    ucLvRatioLength = g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_UNIFORMITY_INDEX + 1];
...
void UserCommonDdcciDispCalibReplyDimmingDefine(void)
{
    ...
    if(g_pucDdcciRxBuf[_DDCCI_DISP_CALIB_DIMMING_INDEX] == _DDCCI_DISP_DIMMING_TYPE_GLOBAL)
    {
        ...
        g_pucDdcciTxBuf[7] = _FREESYNC_II_SUPPORT;
