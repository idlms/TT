...
StructSystemDataType code g_stSystemDefaultData =
{
    ...
    _DP_EDID_4K2K_60HZ,//_DP_EDID_1080P,  // DP EDID Select	
    ...
    _DP_EDID_4K2K_60HZ,//0,            // BYTE b3EdidD0 : 3;	// DP0 EDID Select 
    _DP_EDID_4K2K_60HZ,//0,            // BYTE b3EdidD1 : 3;	// DP1 EDID Select 
    0,                                 // BYTE b3EdidD2 : 3;
    0,                                 // BYTE b3EdidD3 : 3;
    ...
    _OFF,								// BYTE ucBG_OnOff;	
	255,								// BYTE ucBG_ColorR;
	255,								// BYTE ucBG_ColorG;
	255,								// BYTE ucBG_ColorB;
	1,									// BYTE ucLvds_Clock_Driving;
	1,									// BYTE ucLvds_Data_Driving;
};
#endif
...
/* #if((_DIGITAL_PORT_SUPPORT == _ON) &&\
    ((_HDMI_FREESYNC_SUPPORT == _ON) || (_TMDS_HDCP_2_2_SUPPORT == _ON)))	
        ...
        case _DP_ILLEGAL_IDLE_PATTERN_CHECK:
            ...
            break;
		case _BG_ONOFF:	
			ucValue = g_stSystemData.ucBG_OnOff;
			break;
    	case _BG_COLOR_R:
			ucValue = g_stSystemData.ucBG_ColorR;
			break;
    	case _BG_COLOR_G:
			ucValue = g_stSystemData.ucBG_ColorG;
			break;
    	case _BG_COLOR_B:
			ucValue = g_stSystemData.ucBG_ColorB;
			break;
		case _LVDS_CLOCK_DRIVING:
			ucValue = g_stSystemData.ucLvds_Clock_Driving;
			break;
    	case _LVDS_DATA_DRIVING:
			ucValue = g_stSystemData.ucLvds_Data_Driving;
			break;
...
//#else
            ...
            else
            {
                ...
                SET_HDMI_HOTPLUG_TOGGLE();		// Allways On
            }
//#endif
#endif
            break;
		...
		case _BG_ONOFF:	
			 g_stSystemData.ucBG_OnOff = ucValue;
			break;
    	case _BG_COLOR_R:
			g_stSystemData.ucBG_ColorR = ucValue;
			break;
    	case _BG_COLOR_G:
			g_stSystemData.ucBG_ColorG = ucValue;
			break;
    	case _BG_COLOR_B:
			g_stSystemData.ucBG_ColorB = ucValue;
			break;
		case _LVDS_CLOCK_DRIVING:
			g_stSystemData.ucLvds_Clock_Driving = ucValue;
			break;
    	case _LVDS_DATA_DRIVING:
			g_stSystemData.ucLvds_Data_Driving = ucValue;
			break;	
        default:
            break;
    }
...
bit UserCommonEepromWrite(WORD usSubAddr, WORD usLength, BYTE *pucWriteArray)
{
    ...
    PCB_EEPROM_WRITE_PROTECT(_EEPROM_WP_DISABLE);		// Disable EEPROM Write Protect
	
#if(_USER_SYSTEM_EEPROM_CUSTOMIZATION == _ON)
    if(UserInterfaceSystemEepromWriteCustomProc(usSubAddr, usLength, pucWriteArray) == _FAIL)
    {
		PCB_EEPROM_WRITE_PROTECT(_EEPROM_WP_ENABLE);	// Enable EEPROM Write Protect
        return _FAIL;
    }
