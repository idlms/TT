...
#define GET_SOURCE_BG_SCAN_TYPE()               (g_stInputInfo.b1SourceBgSwitchType)
#define SET_SOURCE_BG_SCAN_TYPE(x)              (g_stInputInfo.b1SourceBgSwitchType = (x))

#define GET_SOURCE_BG_STABLE_CHECK_EN()         (g_stInputInfo.b1SourceBgStableCheckEn)
#define SET_SOURCE_BG_STABLE_CHECK_EN()         (g_stInputInfo.b1SourceBgStableCheckEn = 1)
#define CLR_SOURCE_BG_STABLE_CHECK_EN()         (g_stInputInfo.b1SourceBgStableCheckEn = 0)
#endif
...
#define GET_SOURCE_HDMI_SWITCH_TIMEOUT()        (g_stInputInfo.b1SourceHdmiSwitchTimeout)
#define SET_SOURCE_HDMI_SWITCH_TIMEOUT()        (g_stInputInfo.b1SourceHdmiSwitchTimeout = 1)
#define CLR_SOURCE_HDMI_SWITCH_TIMEOUT()        (g_stInputInfo.b1SourceHdmiSwitchTimeout = 0)
#endif
...
#define GET_RUN_UART_COMMAND()                     (g_stUartData.b1RunUartCommand)
#define SET_RUN_UART_COMMAND(x)                    (g_stUartData.b1RunUartCommand = (x))
#define GET_UART_TX_COMMAND()                     (g_stUartData.b1UartTxCommand)
#define SET_UART_TX_COMMAND(x)                    (g_stUartData.b1UartTxCommand = (x))
#endif
//--------------------------------------------------
...
#if(_SOURCE_BACKGROUND_DETECT_SUPPORT == _ON)
    BYTE b1SourceBgSwitchType : 1; // 0 : fixed;
...
typedef struct
{
	BYTE g_ucUartRxConunt;
	BYTE g_ucUartTxConunt;


	BYTE b1RunUartCommand : 1;
	BYTE b1UartTxCommand : 1;

}StructUartType;

typedef enum
{
	_UART_RX_CMD1_00 = 0x00,
	_UART_RX_CMD2_01,
	_UART_RX_SPACE_02,
	_UART_RX_NULL_03,
	_UART_RX_NULL_04,
...
typedef enum
{
	_UART_TX_CMD2_00 = 0x00,
	_UART_TX_SPACE_01,
	_UART_TX_NULL_02,
	_UART_TX_NULL_03,
	_UART_TX_SPACE_04,
	_UART_TX_STATUS1_05,
	_UART_TX_STATUS2_06,//hwang
	_UART_TX_DATA1_07,
	_UART_TX_DATA2_08,
...
#if(_DISTECK_UART_SUPPORT == _ON) 
extern StructUartType idata g_stUartData;
extern BYTE g_ucUartRxBuf[];
extern BYTE g_ucUartTxBuf[];
#endif //#if(_DISTECK_UART_SUPPORT == _ON)
...
extern void SysDpMacArbiter(EnumSourceSearchPort enumInputPort);
#endif
...
#if(_DISTECK_UART_SUPPORT == _ON)
extern void SysUartHandler(void);
#endif
